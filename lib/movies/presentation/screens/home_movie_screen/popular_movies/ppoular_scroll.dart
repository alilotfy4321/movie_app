...
class PopularScrollPart extends StatelessWidget {
  @override
      ...
      builder: (context, state) {
        ...
        return SingleChildScrollView(
          ...
          child: Row(
            ...
            cubit.popularMoviesList.length,
              (index) => Container(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(
                                '${EndPoints.imageBaseUrl}${cubit.popularMoviesList[index].backdropPath},'),
                            fit: BoxFit.cover),
                      ),
                    ),
                    //--------------------2
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            '${cubit.popularMoviesList[index].voteAverage.toStringAsFixed(1)}',
                    ...
                    SizedBox(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          '${cubit.popularMoviesList[index].name}',
